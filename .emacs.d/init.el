...
(custom-set-variables
 ...
 '(package-selected-packages
   '(spacemacs-theme exec-path-from-shell ivy-hydra ivy-prescient prescient amx evil doom-modeline flycheck crux smartparens company-lsp company which-key lsp-ui lsp-mode use-package)))
(custom-set-faces
